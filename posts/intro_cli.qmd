...
<figure>
    <img src="../images/terminal-bash.png" class="center" width="100%">
...
<figure>
    <img src="../images/iTerm-zsh.png" class="center" width="100%">
    <figcaption style="text-align:center; text-size=70%;">
...
**Note #1:** As defined above, shell scripts are text files of shell code that can
...
**Note #2:** in the below code, `#` precedes a "comment", which is only intended to
explain the code and is _not_ executable code.
